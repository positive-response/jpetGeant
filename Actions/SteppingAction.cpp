...
SteppingAction::SteppingAction() { G4TransportationManager::GetTransportationManager()->GetNavigatorForTracking()->SetPushVerbosity(0); }
...
void SteppingAction::UserSteppingAction(const G4Step* aStep)
{
  ...
  if ("Transportation" == aStep->GetPostStepPoint()->GetProcessDefinedStep()->GetProcessName())
    return;
  if (aStep->GetTrack()->GetParentID() != 0)
    return;
  if (nullptr != aStep->GetPostStepPoint()->GetPhysicalVolume()->GetLogicalVolume()->GetSensitiveDetector())
    return;
