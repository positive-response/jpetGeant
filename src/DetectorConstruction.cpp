...
G4VPhysicalVolume* DetectorConstruction::Construct()
{
  ...
  worldPhysical = new G4PVPlacement(
    0, G4ThreeVector(), worldLogical,
...
void DetectorConstruction::LoadGeometryForRun(G4int nr)
{
  ...
  if (fRunNumber == 3 || fRunNumber == 5 || fRunNumber == 6 || fRunNumber == 0) {
    ...
    G4Exception(
      "DetectorConstruction", "DC02", FatalException, " This run setup is not implemented "
    );
  }
}
...
void DetectorConstruction::ConstructTargetRun6()
{
  ...
  G4LogicalVolume* bigChamber_logical = new G4LogicalVolume(
    bigChamber, plexiglassMaterial, "bigChamber_logical"
  );
  ...
  new G4PVPlacement(
    ...
    worldLogical, true, 0, checkOverlaps
  );
  ...
  G4LogicalVolume* conn_logical = new G4LogicalVolume(
    conn, aluminiumMaterial, "conn_logical"
  );
  ...
  G4LogicalVolume* unionSolid_logical = new G4LogicalVolume(
    unionSolid, aluminiumMaterial, "union_logical"
  );
  ...
  G4LogicalVolume* xadFilling_logical = new G4LogicalVolume(
    xadFilling, XADMaterial, "xadFilling_logical"
  );
  ...
  new G4PVPlacement(
    transform, xadFilling_logical, "xadFillingGeom", worldLogical, true, 0, checkOverlaps
  );
  ...
  G4LogicalVolume* kaptonFilling_logical = new G4LogicalVolume(
    kaptonFilling, kapton, "kaptonFilling_logical"
  );
...
void DetectorConstruction::ConstructTargetRun5()
{
  ...
  G4LogicalVolume* smallChamber_logical = new G4LogicalVolume(
    smallChamber, smallChamberMaterial, "smallChamber_logical"
  );
  ...
  G4Transform3D transform(rot, loc);
  new G4PVPlacement(
    transform, smallChamber_logical, "smallChamberGeom", worldLogical, true, 0, checkOverlaps
  );
...
void DetectorConstruction::ConstructTargetRun3()
{
  ...
  G4LogicalVolume* bigChamber_logical = new G4LogicalVolume(
    bigChamber, aluminiumMaterial, "bigChamber_logical"
  );
...
void DetectorConstruction::ConstructScintillators()
{
  ...
  for (int j = 0; j < DetectorConstants::layers; j++) {
    for (int i = 0; i < DetectorConstants::nSegments[j]; i++) {
      ...
      new G4PVPlacement(
        transform, scinLog, name, worldLogical, true, icopy, checkOverlaps
      );
      ...
      if (fLoadWrapping) {
        ...
        new G4PVPlacement(
          transform, wrappingLog, nameWrapping, worldLogical, true, icopy, checkOverlaps
        );
      }
...
void DetectorConstruction::ConstructScintillatorsModularLayer()
{
  ...
  scinLogInModule = new G4LogicalVolume(
    scinBoxInModule, scinMaterial, "scinBoxInModule"
  );
  ...
  for (int i = 0; i < DetectorConstants::modulesInModularLayer; i++) {
    ...
    for (int j = -6; j < 7; j++) {
      ...
      new G4PVPlacement(
        transform, scinLogInModule, nameNewI, worldLogical,
...
void DetectorConstruction::ConstructFrameCAD()
{
  ...
  G4LogicalVolume* cad_logical = new G4LogicalVolume(
    cad_solid1, detectorMaterial, "cad_logical"
  );
  G4VisAttributes* DetVisAtt =  new G4VisAttributes(G4Colour(0.9, 0.9, 0.9));
  DetVisAtt->SetForceWireframe(true);
  DetVisAtt->SetForceSolid(true);
  ...
  G4Transform3D transform(rot, loc);
  new G4PVPlacement(
    transform, cad_logical, "cadGeom", worldLogical, true, 0, checkOverlaps
  );
}
