...
private:
  ...
  G4PrimaryVertex* GenerateThreeGammaVertex(const MaterialExtension::DecayChannel channel, const G4ThreeVector vtxPosition, const G4double T0, const G4double lifetime3g);
  ...
  G4double calculate_mQED(const MaterialExtension::DecayChannel channel, Double_t mass_e, Double_t w1, Double_t w2, Double_t w3);
